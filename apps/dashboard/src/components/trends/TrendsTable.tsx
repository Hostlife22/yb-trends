...
const COLUMNS: ColumnDef[] = [
  ...
  { label: 'Year', key: 'release_year', align: 'left' },
  { label: 'Lang', key: 'original_language', align: 'left' },
  { label: 'Studio', key: 'studio', align: 'left' },
  { label: 'Score', key: 'final_score', align: 'left' },
  { label: 'YT Views (14d)', key: 'youtube_total_views_14d', align: 'right' },
  { label: 'YT Videos (14d)', key: 'youtube_videos_published_14d', align: 'right' },
